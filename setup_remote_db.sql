...
-- Link: https://supabase.com/dashboard/project/rtynzismiymxhihwdmhs/sql/new
...
drop policy if exists "Users can view chat messages for their projects" on public.chat_messages;
drop policy if exists "Users can insert chat messages for their projects" on public.chat_messages;
...
drop policy if exists "Users can view resume versions for their projects" on public.resume_versions;
drop policy if exists "Users can insert resume versions for their projects" on public.resume_versions;
